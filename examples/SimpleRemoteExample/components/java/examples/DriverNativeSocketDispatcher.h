#ifndef EXAMPLES_DRIVERNATIVESOCKETDISPATCHER_H_
#define EXAMPLES_DRIVERNATIVESOCKETDISPATCHER_H_ 
...
class examples::DriverNativeSocketDispatcher: public examples::DriverNativeDispatcher{
  private:
