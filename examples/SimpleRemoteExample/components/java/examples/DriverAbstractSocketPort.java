...
public abstract class DriverAbstractSocketPort extends SocketComponent implements DriverSocketPort{

  protected Driver  _destination;
  
  public DriverAbstractSocketPort() throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    _destination = null;
  }
  
  public DriverAbstractSocketPort(String host,int port) throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    super(host,port);
    _destination = null;
  }
