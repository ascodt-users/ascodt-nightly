#ifndef EXAMPLES_DRIVER2NATIVE2JAVAPLAINPORT_H_
#define EXAMPLES_DRIVER2NATIVE2JAVAPLAINPORT_H_ 
...
class examples::DriverNative2JavaPlainPort: public examples::Driver{
  private:
    JavaVM* _jvm;
    jobject _obj;
  public:
