#ifndef EXAMPLES_FOONATIVESOCKETDISPATCHER_H_
#define EXAMPLES_FOONATIVESOCKETDISPATCHER_H_ 
...
class examples::FooNativeSocketDispatcher: public examples::FooNativeDispatcher{
  private:
