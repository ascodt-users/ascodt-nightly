...
examples::heat::MeshCxx2SocketPlainPort::MeshCxx2SocketPlainPort(char* host,int port,int buffer_size):
     _buffer_size(buffer_size){
     _rcvBuffer=new char[_buffer_size];
     _sendBuffer=new char[_buffer_size];
     examples::heat::MeshCxx2SocketPlainPort::open_client(host,port,_sockfd,_newsockfd);
     
}

examples::heat::MeshCxx2SocketPlainPort::MeshCxx2SocketPlainPort(int port,int buffer_size):
    _buffer_size(buffer_size){
    _rcvBuffer=new char[_buffer_size];
    _sendBuffer=new char[_buffer_size];
    //examples::heat::MeshCxx2SocketPlainPort::open_server(port,_sockfd,_newsockfd);
}

examples::heat::MeshCxx2SocketPlainPort::~MeshCxx2SocketPlainPort(){
     int method=-1;
     ...
     examples::heat::MeshCxx2SocketPlainPort::close(_sockfd,_newsockfd);
     
}


//int examples::heat::MeshCxx2SocketPlainPort::getSockfd(){
//     return _sockfd;
//}
//int examples::heat::MeshCxx2SocketPlainPort::getNewsockfd(){
//     return _newsockfd;
//}

void examples::heat::MeshCxx2SocketPlainPort::open_client(char* hostname,int port,
#ifdef _WIN32
SOCKET
#else
int
...
/*
void examples::heat::MeshCxx2SocketPlainPort::open_server(int port,int &sockfd,int &newsockfd){
          socklen_t clilen;
...
void examples::heat::MeshCxx2SocketPlainPort::sendData(char* data, size_t numberOfBytes, char* sendBuffer,
#ifdef _WIN32
SOCKET
#else
int
...
void examples::heat::MeshCxx2SocketPlainPort::readData(char* data,size_t size_of_data,char* readBuffer,
#ifdef _WIN32
SOCKET
#else
int
...
void examples::heat::MeshCxx2SocketPlainPort::close(
#ifdef _WIN32
SOCKET
#else
int
...
void examples::heat::MeshCxx2SocketPlainPort::allocate(const int* dim, const int dim_len){
...
void examples::heat::MeshCxx2SocketPlainPort::getData(double* data, const int data_len){
     //assert(_destination!=NULL);
     #ifdef _WIN32
#else
#endif
