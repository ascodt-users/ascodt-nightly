module examples_heat_Driver2SocketPort 
...
subroutine create_port_client_instance_for_c(this,host,port,buffer_size)
    ...
    call examples_heat_driverc2socket_plain_port_create_client_instance(this%reference,host,port,buffer_size)
...
subroutine destroyPortInstance(this)
     class(Driver2SocketPort)::this
     call examples_heat_driverc2socket_plain_port_destroy_instance(this%reference)
...
subroutine go(this)
     ...
     call examples_heat_driverc2socket_plain_port_go(this%reference)
end subroutine go

end module  examples_heat_Driver2SocketPort
