...
de::tum::DriverCxx2SocketPlainPort::DriverCxx2SocketPlainPort(char* host,int port,int buffer_size):
     _buffer_size(buffer_size){
     _rcvBuffer=new char[_buffer_size];
     _sendBuffer=new char[_buffer_size];
     de::tum::DriverCxx2SocketPlainPort::open_client(host,port,_sockfd,_newsockfd);
     
}

de::tum::DriverCxx2SocketPlainPort::DriverCxx2SocketPlainPort(int port,int buffer_size):
    _buffer_size(buffer_size){
    _rcvBuffer=new char[_buffer_size];
    _sendBuffer=new char[_buffer_size];
    //de::tum::DriverCxx2SocketPlainPort::open_server(port,_sockfd,_newsockfd);
}

de::tum::DriverCxx2SocketPlainPort::~DriverCxx2SocketPlainPort(){
     int method=-1;
     ...
     de::tum::DriverCxx2SocketPlainPort::close(_sockfd,_newsockfd);
     
}


//int de::tum::DriverCxx2SocketPlainPort::getSockfd(){
//     return _sockfd;
//}
//int de::tum::DriverCxx2SocketPlainPort::getNewsockfd(){
//     return _newsockfd;
//}

void de::tum::DriverCxx2SocketPlainPort::open_client(char* hostname,int port,
#ifdef _WIN32
SOCKET
#else
int
...
/*
void de::tum::DriverCxx2SocketPlainPort::open_server(int port,int &sockfd,int &newsockfd){
          socklen_t clilen;
...
void de::tum::DriverCxx2SocketPlainPort::sendData(char* data, size_t numberOfBytes, char* sendBuffer,
#ifdef _WIN32
SOCKET
#else
int
...
void de::tum::DriverCxx2SocketPlainPort::readData(char* data,size_t size_of_data,char* readBuffer,
#ifdef _WIN32
SOCKET
#else
int
...
void de::tum::DriverCxx2SocketPlainPort::close(
#ifdef _WIN32
SOCKET
#else
int
...
void de::tum::DriverCxx2SocketPlainPort::go(){
