...
de::tum::FooBarCxx2SocketPlainPort::FooBarCxx2SocketPlainPort(char* host,int port,int buffer_size):
     _buffer_size(buffer_size){
     _rcvBuffer=new char[_buffer_size];
     _sendBuffer=new char[_buffer_size];
     de::tum::FooBarCxx2SocketPlainPort::open_client(host,port,_sockfd,_newsockfd);
     
}

de::tum::FooBarCxx2SocketPlainPort::FooBarCxx2SocketPlainPort(int port,int buffer_size):
    _buffer_size(buffer_size){
    _rcvBuffer=new char[_buffer_size];
    _sendBuffer=new char[_buffer_size];
    //de::tum::FooBarCxx2SocketPlainPort::open_server(port,_sockfd,_newsockfd);
}

de::tum::FooBarCxx2SocketPlainPort::~FooBarCxx2SocketPlainPort(){
     int method=-1;
     ...
     de::tum::FooBarCxx2SocketPlainPort::close(_sockfd,_newsockfd);
     
}


//int de::tum::FooBarCxx2SocketPlainPort::getSockfd(){
//     return _sockfd;
//}
//int de::tum::FooBarCxx2SocketPlainPort::getNewsockfd(){
//     return _newsockfd;
//}

void de::tum::FooBarCxx2SocketPlainPort::open_client(char* hostname,int port,
#ifdef _WIN32
SOCKET
#else
int
...
/*
void de::tum::FooBarCxx2SocketPlainPort::open_server(int port,int &sockfd,int &newsockfd){
          socklen_t clilen;
...
void de::tum::FooBarCxx2SocketPlainPort::sendData(char* data, size_t numberOfBytes, char* sendBuffer,
#ifdef _WIN32
SOCKET
#else
int
...
void de::tum::FooBarCxx2SocketPlainPort::readData(char* data,size_t size_of_data,char* readBuffer,
#ifdef _WIN32
SOCKET
#else
int
...
void de::tum::FooBarCxx2SocketPlainPort::close(
#ifdef _WIN32
SOCKET
#else
int
...
void de::tum::FooBarCxx2SocketPlainPort::foo(const double* data, const int data_len){
...
void de::tum::FooBarCxx2SocketPlainPort::bar(double* data, const int data_len){
     //assert(_destination!=NULL);
     #ifdef _WIN32
#else
#endif
...
void de::tum::FooBarCxx2SocketPlainPort::reset(){
     //assert(_destination!=NULL);
     #ifdef _WIN32
#else
#endif
