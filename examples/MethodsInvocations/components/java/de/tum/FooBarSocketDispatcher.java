...
public class FooBarSocketDispatcher extends  SocketComponent {
  private long _ref;
  protected java.util.HashSet<FooBar>  _destinations;
  
  public FooBarSocketDispatcher() throws de.tum.ascodt.utils.exceptions.ASCoDTException{
    _destinations = new java.util.HashSet<FooBar>();
