...
public abstract class ExampleComponentAbstractJavaImplementation extends SocketComponent implements ExampleComponent{
  protected de.tum.ascodt.plugin.ui.tabs.SocketClientAppsTab _appTab;
  protected String   _instanceName;
  protected String _projectLocation;
  public ExampleComponentAbstractJavaImplementation( String instanceName ) throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    _instanceName = instanceName;
    _appTab = new de.tum.ascodt.plugin.ui.tabs.SocketClientAppsTab("ExampleComponent",this, de.tum.ascodt.plugin.ui.views.AppsViewContainer.ID);
...
sendDoubleData(data);
       ...
       de.tum.ascodt.plugin.utils.exceptions.ErrorWriterDevice.getInstance().showError( getClass().getName() , "foo()", e);
    }  
  }
...
sendDoubleData(data);
         ...
         int data_len;
data_len=readIntData();
readDoubleData(data,data_len);
  
    }catch(de.tum.ascodt.utils.exceptions.ASCoDTException e){
       de.tum.ascodt.plugin.utils.exceptions.ErrorWriterDevice.getInstance().showError( getClass().getName() , "bar()", e);
    }  
  }
  ...
  public void reset() {
    ...
    try{
       ...
       de.tum.ascodt.plugin.utils.exceptions.ErrorWriterDevice.getInstance().showError( getClass().getName() , "reset()", e);
    }  
  }
