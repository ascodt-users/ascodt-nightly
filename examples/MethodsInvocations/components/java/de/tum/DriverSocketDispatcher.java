...
public class DriverSocketDispatcher extends  SocketComponent {
  private long _ref;
  protected java.util.HashSet<Driver>  _destinations;
  
  public DriverSocketDispatcher() throws de.tum.ascodt.utils.exceptions.ASCoDTException{
    _destinations = new java.util.HashSet<Driver>();
