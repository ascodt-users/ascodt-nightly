...
public abstract class FooBarAbstractSocketPort extends SocketComponent implements FooBarSocketPort{

  protected FooBar  _destination;
  
  public FooBarAbstractSocketPort() throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    _destination = null;
  }
  
  public FooBarAbstractSocketPort(String host,int port) throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    super(host,port);
    _destination = null;
  }
