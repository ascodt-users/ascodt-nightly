...
public abstract class IntegratorAbstractSocketPort extends SocketComponent implements IntegratorSocketPort{

  protected Integrator  _destination;
  
  public IntegratorAbstractSocketPort() throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    _destination = null;
  }
  
  public IntegratorAbstractSocketPort(String host,int port) throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    super(host,port);
    _destination = null;
  }
