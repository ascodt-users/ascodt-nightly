...
public class StencilSocket2JavaPlainPort extends StencilAbstractSocketPort 
     implements java.lang.Runnable,java.nio.channels.CompletionHandler< java.nio.channels.AsynchronousSocketChannel, Object>{

  interface StencilSocketInvoker {
    void invoke() throws de.tum.ascodt.utils.exceptions.ASCoDTException;
  } 
  private long _ref;
  private StencilSocketInvoker[] _invokers;
  private java.util.concurrent.ExecutorService _executor;
  public StencilSocket2JavaPlainPort(String host,int port) throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    super(host,port);
    _invokers = new  StencilSocketInvoker[235];
    	_invokers[36]= new StencilSocketInvoker(){
  ...
  public StencilSocket2JavaPlainPort() throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    super();
    _invokers = new  StencilSocketInvoker[235];
    	_invokers[36]= new StencilSocketInvoker(){
		public void invoke() throws de.tum.ascodt.utils.exceptions.ASCoDTException{
  ...
  public void run(){
     ...
     try{
          ...
          de.tum.ascodt.plugin.utils.exceptions.ErrorWriterDevice.getInstance().showError(
            StencilSocket2JavaPlainPort.class.getCanonicalName(),
            "run()",
  ...
  public void invoke_getStencil() throws 
...
readDoubleData(stencil,stencil_len);
     ...
     getStencil(stencil);
     sendIntData(stencil.length);
sendDoubleData(stencil);
