...
public abstract class RegularGridAbstractSocketPort extends SocketComponent implements RegularGridSocketPort{

  protected RegularGrid  _destination;
  
  public RegularGridAbstractSocketPort() throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    _destination = null;
  }
  
  public RegularGridAbstractSocketPort(String host,int port) throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    super(host,port);
    _destination = null;
  }
