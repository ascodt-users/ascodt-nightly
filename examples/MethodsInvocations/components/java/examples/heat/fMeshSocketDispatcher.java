...
public class fMeshSocketDispatcher extends  SocketComponent {
  private long _ref;
  protected java.util.HashSet<fMesh>  _destinations;
  
  public fMeshSocketDispatcher() throws de.tum.ascodt.utils.exceptions.ASCoDTException{
    _destinations = new java.util.HashSet<fMesh>();
