...
public abstract class Plotter2DAbstractSocketPort extends SocketComponent implements Plotter2DSocketPort{

  protected Plotter2D  _destination;
  
  public Plotter2DAbstractSocketPort() throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    _destination = null;
  }
  
  public Plotter2DAbstractSocketPort(String host,int port) throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    super(host,port);
    _destination = null;
  }
