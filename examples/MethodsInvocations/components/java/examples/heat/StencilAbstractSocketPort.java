...
public abstract class StencilAbstractSocketPort extends SocketComponent implements StencilSocketPort{

  protected Stencil  _destination;
  
  public StencilAbstractSocketPort() throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    _destination = null;
  }
  
  public StencilAbstractSocketPort(String host,int port) throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    super(host,port);
    _destination = null;
  }
