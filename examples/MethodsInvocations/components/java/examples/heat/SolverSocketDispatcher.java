...
public class SolverSocketDispatcher extends  SocketComponent {
  private long _ref;
  protected java.util.HashSet<Solver>  _destinations;
  
  public SolverSocketDispatcher() throws de.tum.ascodt.utils.exceptions.ASCoDTException{
    _destinations = new java.util.HashSet<Solver>();
