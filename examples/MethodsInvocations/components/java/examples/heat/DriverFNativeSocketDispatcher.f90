module examples_heat_DriverFNativeSocketDispatcher
...
subroutine createClientDispatcherInstanceForC(this,host,port,buffer_size)
    ...
    this%reference=0
    call examples_heat_driver_f2c_nsd_create_client_instance(this%reference,host,port,buffer_size)
...
subroutine destroyDispatcherInstance(this)
     class(DriverNativeSocketDispatcher)::this
     call examples_heat_driver_f2c_nsd_destroy_instance(this%reference)
...
subroutine go_internal(this)
     ...
     call examples_heat_driver_f2c_nsd_go(this%reference)
...
end module  examples_heat_DriverFNativeSocketDispatcher
