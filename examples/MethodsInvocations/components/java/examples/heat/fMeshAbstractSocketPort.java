...
public abstract class fMeshAbstractSocketPort extends SocketComponent implements fMeshSocketPort{

  protected fMesh  _destination;
  
  public fMeshAbstractSocketPort() throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    _destination = null;
  }
  
  public fMeshAbstractSocketPort(String host,int port) throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    super(host,port);
    _destination = null;
  }
