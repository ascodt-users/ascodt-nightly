...
public abstract class AdamsMoultonAbstractJavaNativeImplementation implements AdamsMoulton {
  /**
   * Semaphore object.
   */
  ...
  public AdamsMoultonAbstractJavaNativeImplementation(String instanceName) {
    assert(instanceName!=null); 
    _instanceName = instanceName;
    _isLocked     = false;
   
    System.load("/work_fast/atanasoa/Programme/runtime-HelloSocketFortran/MethodsInvocations/native/libAdamsMoulton.so");
    createInstance();
  }
