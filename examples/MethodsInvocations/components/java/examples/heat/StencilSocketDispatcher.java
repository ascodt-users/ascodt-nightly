...
public class StencilSocketDispatcher extends  SocketComponent {
  private long _ref;
  protected java.util.HashSet<Stencil>  _destinations;
  
  public StencilSocketDispatcher() throws de.tum.ascodt.utils.exceptions.ASCoDTException{
    _destinations = new java.util.HashSet<Stencil>();
