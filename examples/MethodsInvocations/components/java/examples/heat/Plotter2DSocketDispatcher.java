...
public class Plotter2DSocketDispatcher extends  SocketComponent {
  private long _ref;
  protected java.util.HashSet<Plotter2D>  _destinations;
  
  public Plotter2DSocketDispatcher() throws de.tum.ascodt.utils.exceptions.ASCoDTException{
    _destinations = new java.util.HashSet<Plotter2D>();
