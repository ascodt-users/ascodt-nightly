...
public class IntegratorSocketDispatcher extends  SocketComponent {
  private long _ref;
  protected java.util.HashSet<Integrator>  _destinations;
  
  public IntegratorSocketDispatcher() throws de.tum.ascodt.utils.exceptions.ASCoDTException{
    _destinations = new java.util.HashSet<Integrator>();
