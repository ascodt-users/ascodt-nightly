...
cca::cfd::LB2NSCxx2SocketPlainPort::LB2NSCxx2SocketPlainPort(char* host,int port,int buffer_size):
     _buffer_size(buffer_size){
     _rcvBuffer=new char[_buffer_size];
     _sendBuffer=new char[_buffer_size];
     cca::cfd::LB2NSCxx2SocketPlainPort::open_client(host,port,_sockfd,_newsockfd);
     
}

cca::cfd::LB2NSCxx2SocketPlainPort::LB2NSCxx2SocketPlainPort(int port,int buffer_size):
    _buffer_size(buffer_size){
    _rcvBuffer=new char[_buffer_size];
    _sendBuffer=new char[_buffer_size];
    //cca::cfd::LB2NSCxx2SocketPlainPort::open_server(port,_sockfd,_newsockfd);
}

cca::cfd::LB2NSCxx2SocketPlainPort::~LB2NSCxx2SocketPlainPort(){
     int method=-1;
     ...
     cca::cfd::LB2NSCxx2SocketPlainPort::close(_sockfd,_newsockfd);
     
}


//int cca::cfd::LB2NSCxx2SocketPlainPort::getSockfd(){
//     return _sockfd;
//}
//int cca::cfd::LB2NSCxx2SocketPlainPort::getNewsockfd(){
//     return _newsockfd;
//}

void cca::cfd::LB2NSCxx2SocketPlainPort::open_client(char* hostname,int port,
#ifdef _WIN32
SOCKET
#else
int
...
/*
void cca::cfd::LB2NSCxx2SocketPlainPort::open_server(int port,int &sockfd,int &newsockfd){
          socklen_t clilen;
...
void cca::cfd::LB2NSCxx2SocketPlainPort::sendData(char* data, size_t numberOfBytes, char* sendBuffer,
#ifdef _WIN32
SOCKET
#else
int
...
void cca::cfd::LB2NSCxx2SocketPlainPort::readData(char* data,size_t size_of_data,char* readBuffer,
#ifdef _WIN32
SOCKET
#else
int
...
void cca::cfd::LB2NSCxx2SocketPlainPort::close(
#ifdef _WIN32
SOCKET
#else
int
...
void cca::cfd::LB2NSCxx2SocketPlainPort::iterateBoundary(){
...
void cca::cfd::LB2NSCxx2SocketPlainPort::iterateBoundaryParallel(){
     //assert(_destination!=NULL);
     int flags;
     flags = fcntl(_newsockfd, F_GETFL, 0);
     flags ^= O_NONBLOCK;
...
void cca::cfd::LB2NSCxx2SocketPlainPort::iterateInner(){
     //assert(_destination!=NULL);
     #ifdef _WIN32
#else
int flags;
...
void cca::cfd::LB2NSCxx2SocketPlainPort::iterateInnerParallel(){
     //assert(_destination!=NULL);
     int flags;
     flags = fcntl(_newsockfd, F_GETFL, 0);
     flags ^= O_NONBLOCK;
...
void cca::cfd::LB2NSCxx2SocketPlainPort::retrieveTimestep(double& dt){
     //assert(_destination!=NULL);
     #ifdef _WIN32
#else
int flags;
...
fcntl(_newsockfd, F_SETFL, flags);
     ...
     int methodId=14;
     sendData((char*) &methodId, sizeof(int),_sendBuffer,_newsockfd,_buffer_size);
     sendData((char*)&dt,sizeof(double),_sendBuffer,_newsockfd,_buffer_size);

     readData((char*)&dt,sizeof(double),_rcvBuffer,_newsockfd,_buffer_size);

}

void cca::cfd::LB2NSCxx2SocketPlainPort::retrieveTimestepParallel(double& dt){
     //assert(_destination!=NULL);
     int flags;
     flags = fcntl(_newsockfd, F_GETFL, 0);
     flags ^= O_NONBLOCK;
...
void cca::cfd::LB2NSCxx2SocketPlainPort::retrieveVelocitiesSize(int& memoryX,int& memoryY,int& memoryZ){
     //assert(_destination!=NULL);
     #ifdef _WIN32
#else
int flags;
...
fcntl(_newsockfd, F_SETFL, flags);
     ...
     int methodId=16;
     sendData((char*) &methodId, sizeof(int),_sendBuffer,_newsockfd,_buffer_size);
     sendData((char*)&memoryX,sizeof(int),_sendBuffer,_newsockfd,_buffer_size);
sendData((char*)&memoryY,sizeof(int),_sendBuffer,_newsockfd,_buffer_size);
sendData((char*)&memoryZ,sizeof(int),_sendBuffer,_newsockfd,_buffer_size);

     readData((char*)&memoryX,sizeof(int),_rcvBuffer,_newsockfd,_buffer_size);
readData((char*)&memoryY,sizeof(int),_rcvBuffer,_newsockfd,_buffer_size);
readData((char*)&memoryZ,sizeof(int),_rcvBuffer,_newsockfd,_buffer_size);

}

void cca::cfd::LB2NSCxx2SocketPlainPort::retrieveVelocitiesSizeParallel(int& memoryX,int& memoryY,int& memoryZ){
     //assert(_destination!=NULL);
     int flags;
     flags = fcntl(_newsockfd, F_GETFL, 0);
     flags ^= O_NONBLOCK;
...
void cca::cfd::LB2NSCxx2SocketPlainPort::retrieveVelocitiesCopy(double* velocityX, const int velocityX_len,double* velocityY, const int velocityY_len,double* velocityZ, const int velocityZ_len){
     //assert(_destination!=NULL);
     #ifdef _WIN32
#else
int flags;
...
void cca::cfd::LB2NSCxx2SocketPlainPort::retrieveVelocitiesCopyParallel(double* velocityX, const int velocityX_len,double* velocityY, const int velocityY_len,double* velocityZ, const int velocityZ_len){
     //assert(_destination!=NULL);
     int flags;
     flags = fcntl(_newsockfd, F_GETFL, 0);
     flags ^= O_NONBLOCK;
