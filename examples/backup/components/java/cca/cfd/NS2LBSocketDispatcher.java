...
public class NS2LBSocketDispatcher extends  SocketComponent {
  private long _ref;
  protected java.util.HashSet<NS2LB>  _destinations;
  
  public NS2LBSocketDispatcher() throws de.tum.ascodt.utils.exceptions.ASCoDTException{
    _destinations = new java.util.HashSet<NS2LB>();
