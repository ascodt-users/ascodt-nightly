...
public abstract class NS2LBAbstractSocketPort extends SocketComponent implements NS2LBSocketPort{

  protected NS2LB  _destination;
  
  public NS2LBAbstractSocketPort() throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    _destination = null;
  }
  
  public NS2LBAbstractSocketPort(String host,int port) throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    super(host,port);
    _destination = null;
  }
