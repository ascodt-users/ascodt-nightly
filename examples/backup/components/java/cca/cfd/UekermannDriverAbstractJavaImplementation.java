...
public abstract class UekermannDriverAbstractJavaImplementation extends SocketComponent implements UekermannDriver{
  protected de.tum.ascodt.plugin.ui.tabs.SocketClientAppsTab _appTab;
  protected String   _instanceName;
  protected String _projectLocation;
  public UekermannDriverAbstractJavaImplementation( String instanceName ) throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    _instanceName = instanceName;
    _appTab = new de.tum.ascodt.plugin.ui.tabs.SocketClientAppsTab("cca.cfd.UekermannDriver",this, de.tum.ascodt.plugin.ui.views.AppsViewContainer.ID);
