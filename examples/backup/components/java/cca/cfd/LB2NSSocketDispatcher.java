...
public class LB2NSSocketDispatcher extends  SocketComponent {
  private long _ref;
  protected java.util.HashSet<LB2NS>  _destinations;
  
  public LB2NSSocketDispatcher() throws de.tum.ascodt.utils.exceptions.ASCoDTException{
    _destinations = new java.util.HashSet<LB2NS>();
