...
public class LBSolverSocketDispatcher extends  SocketComponent {
  private long _ref;
  protected java.util.HashSet<LBSolver>  _destinations;
  
  public LBSolverSocketDispatcher() throws de.tum.ascodt.utils.exceptions.ASCoDTException{
    _destinations = new java.util.HashSet<LBSolver>();
