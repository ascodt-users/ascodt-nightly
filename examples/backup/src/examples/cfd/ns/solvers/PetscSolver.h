...
class PetscUserCtx{
    ...
    public:
        ...
        // Variables telling where the boundaries of the missing region are
        const int couplingLowerX;
        const int couplingUpperX;
        const int couplingLowerY;
        const int couplingUpperY;
        const int couplingLowerZ;
        const int couplingUpperZ;
...
class PetscSolver : public LinearSolver{
    ...
    public:
        ...
        /** Sets the pointers passed as argument to the arrays with the limits. Used to set the
