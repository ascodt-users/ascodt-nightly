#ifndef _LB_NS_INTERPOLATOR_H_
#define _LB_NS_INTERPOLATOR_H_
...
class LBNSInterpolator {
    ...
    private:
         ...
         */
        void loadVelocityComponent (const int & component);
    ...
    public:
         ...
         */
        LBNSInterpolator (const Parameters & parameters, const LBField & lbField);
