...
subroutine create_port_client_instance_for_c(this,host,port,buffer_size)
    ...
    call test_fooc2socket_plain_port_create_client_instance(this%reference,host,port,buffer_size)
...
subroutine destroyPortInstance(this)
     class(Foo2SocketPort)::this
     call test_fooc2socket_plain_port_destroy_instance(this%reference)
...
subroutine bar(this)
     ...
     call test_fooc2socket_plain_port_bar(this%reference)
end subroutine bar

end module  test_Foo2SocketPort
