...
test::FooCxx2SocketPlainPort::FooCxx2SocketPlainPort(char* host,int port,int buffer_size):
     _buffer_size(buffer_size){
     _rcvBuffer=new char[_buffer_size];
     _sendBuffer=new char[_buffer_size];
     test::FooCxx2SocketPlainPort::open_client(host,port,_sockfd,_newsockfd);
     
}

test::FooCxx2SocketPlainPort::FooCxx2SocketPlainPort(int port,int buffer_size):
    _buffer_size(buffer_size){
    _rcvBuffer=new char[_buffer_size];
    _sendBuffer=new char[_buffer_size];
    //test::FooCxx2SocketPlainPort::open_server(port,_sockfd,_newsockfd);
}

test::FooCxx2SocketPlainPort::~FooCxx2SocketPlainPort(){
     int method=-1;
     ...
     test::FooCxx2SocketPlainPort::close(_sockfd,_newsockfd);
     
}


//int test::FooCxx2SocketPlainPort::getSockfd(){
//     return _sockfd;
//}
//int test::FooCxx2SocketPlainPort::getNewsockfd(){
//     return _newsockfd;
//}

void test::FooCxx2SocketPlainPort::open_client(char* hostname,int port,
#ifdef _WIN32
SOCKET
#else
int
...
/*
void test::FooCxx2SocketPlainPort::open_server(int port,int &sockfd,int &newsockfd){
          socklen_t clilen;
...
void test::FooCxx2SocketPlainPort::sendData(char* data, size_t numberOfBytes, char* sendBuffer,
#ifdef _WIN32
SOCKET
#else
int
...
void test::FooCxx2SocketPlainPort::readData(char* data,size_t size_of_data,char* readBuffer,
#ifdef _WIN32
SOCKET
#else
int
...
void test::FooCxx2SocketPlainPort::close(
#ifdef _WIN32
SOCKET
#else
int
...
void test::FooCxx2SocketPlainPort::bar(){
