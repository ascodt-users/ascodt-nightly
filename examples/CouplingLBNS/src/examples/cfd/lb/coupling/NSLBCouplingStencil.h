...
//	bool _open;
	...
	inline void toGlobalIndex(const int i,const int j, const int k,int& i_out,int& j_out, int& k_out) const;
	inline int index2Varray ( int i, int j, int k, int component, int stencil ) const;
	inline int index2Parray ( int i, int j, int k, int stencil ) const;
