...
class SOAFieldStencil {
    ...
    public:
        ...
        SOAFieldStencil ( const Parameters & parameters );
        virtual ~SOAFieldStencil(){}
         ...
         */
        virtual void apply ( FlowField & flowField,int q, int i, int j) = 0;
         ...
         */
        virtual void apply ( FlowField & flowField,int q, int i, int j, int k) = 0;
