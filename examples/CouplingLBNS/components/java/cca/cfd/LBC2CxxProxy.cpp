...
readData((char*)&ackn,sizeof(int),rcvBuffer,newsockfd,buffer_size);
  ...
  ((cca::cfd::LBImplementation*)*ref)->forwardVelocities(keys,keys_len,offsets,offsets_len,flips,flips_len,values,values_len,componentSize,componentSize_len,ackn);
  delete [] keys;
delete [] offsets;
delete [] flips;
delete [] values;
