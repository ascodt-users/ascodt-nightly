...
public class NSSolverSocketDispatcher extends  SocketComponent {
  private long _ref;
  protected java.util.HashSet<NSSolver>  _destinations;
  
  public NSSolverSocketDispatcher() throws de.tum.ascodt.utils.exceptions.ASCoDTException{
    _destinations = new java.util.HashSet<NSSolver>();
