...
public abstract class LBSolverAbstractSocketPort extends SocketComponent implements LBSolverSocketPort{

  protected LBSolver  _destination;
  
  public LBSolverAbstractSocketPort() throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    _destination = null;
  }
  
  public LBSolverAbstractSocketPort(String host,int port) throws de.tum.ascodt.utils.exceptions.ASCoDTException {
    super(host,port);
    _destination = null;
  }
