...
#ifdef _WIN32
void INITIALISE(CCA_CFD_UEKERMANNDRIVER_arg& arg,bool joinable){
#else
...
#ifdef _WIN32
void BIND_COMPONENT(CCA_CFD_UEKERMANNDRIVER_arg& arg,bool joinable){
#else
void bind_component_(CCA_CFD_UEKERMANNDRIVER_arg& arg,bool joinable){
#endif
   if(arg.java_client_flag)         
     open_client(arg.hostname.c_str(),arg.client_port.c_str(),arg.java_serverfd,arg.java_clientfd);
...
#ifdef _WIN32
void DESTROY(CCA_CFD_UEKERMANNDRIVER_arg& arg, bool joinable){
#else
void destroy_(CCA_CFD_UEKERMANNDRIVER_arg& arg, bool joinable){
#endif
if(joinable){
#ifdef _WIN32
...
#ifdef _WIN32
void SOCKET_LOOP(CCA_CFD_UEKERMANNDRIVER_arg& arg,bool joinable){
#else
