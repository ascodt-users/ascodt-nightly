#include "cca/cfd/CouplingDriverC2CxxProxy.h"
#ifdef _WIN32
	#include <winsock2.h>
	#include <ws2tcpip.h>
...
CCA_CFD_COUPLINGDRIVER_arg daemon_args;
...
void invoker_create_instance(void** ref,int,int,char*,char*
     ...
     *ref = new cca::cfd::CouplingDriverImplementation();
}
...
void invoker_destroy_instance(void** ref,int,int,char*,char*
	 ...
	 ,MPI_Comm communicator,int methodID
      ...
      delete ((cca::cfd::CouplingDriverImplementation*)*ref);
...
,MPI_Comm communicator, int methodId
  ...
  ((cca::cfd::CouplingDriverImplementation*)*ref)->connectns((cca::cfd::NSSolverNativeSocketDispatcher*)portref);   
  delete[]host;
  sendData((char*)&portref,sizeof(long long),sendBuffer,newsockfd,buffer_size);
}
...
void invoker_connect_client_dispatcher_ns(void** ref,void** dispatcherRef, void** portRef, char* host,int port,int buffer_size){
  if(*dispatcherRef==NULL){
     *dispatcherRef=new cca::cfd::NSSolverNativeDispatcher();
     ((cca::cfd::CouplingDriverImplementation*)(*ref))->connectns((cca::cfd::NSSolverNativeDispatcher*) *dispatcherRef);   
  }
...
,MPI_Comm communicator, int methodId
 ...
 ((cca::cfd::CouplingDriverImplementation*)*ref)->disconnectns();
}
...
,MPI_Comm communicator, int methodId
  ...
  ((cca::cfd::CouplingDriverImplementation*)*ref)->connectns2lb((cca::cfd::NS2LBNativeSocketDispatcher*)portref);   
  delete[]host;
  sendData((char*)&portref,sizeof(long long),sendBuffer,newsockfd,buffer_size);
}
...
void invoker_connect_client_dispatcher_ns2lb(void** ref,void** dispatcherRef, void** portRef, char* host,int port,int buffer_size){
  if(*dispatcherRef==NULL){
     *dispatcherRef=new cca::cfd::NS2LBNativeDispatcher();
     ((cca::cfd::CouplingDriverImplementation*)(*ref))->connectns2lb((cca::cfd::NS2LBNativeDispatcher*) *dispatcherRef);   
  }
...
,MPI_Comm communicator, int methodId
 ...
 ((cca::cfd::CouplingDriverImplementation*)*ref)->disconnectns2lb();
}
...
,MPI_Comm communicator, int methodId
  ...
  ((cca::cfd::CouplingDriverImplementation*)*ref)->connectlb2ns((cca::cfd::LB2NSNativeSocketDispatcher*)portref);   
  delete[]host;
  sendData((char*)&portref,sizeof(long long),sendBuffer,newsockfd,buffer_size);
}
...
void invoker_connect_client_dispatcher_lb2ns(void** ref,void** dispatcherRef, void** portRef, char* host,int port,int buffer_size){
  if(*dispatcherRef==NULL){
     *dispatcherRef=new cca::cfd::LB2NSNativeDispatcher();
     ((cca::cfd::CouplingDriverImplementation*)(*ref))->connectlb2ns((cca::cfd::LB2NSNativeDispatcher*) *dispatcherRef);   
  }
...
,MPI_Comm communicator, int methodId
 ...
 ((cca::cfd::CouplingDriverImplementation*)*ref)->disconnectlb2ns();
}
...
,MPI_Comm communicator, int methodId
  ...
  ((cca::cfd::CouplingDriverImplementation*)*ref)->connectlb((cca::cfd::LBSolverNativeSocketDispatcher*)portref);   
  delete[]host;
  sendData((char*)&portref,sizeof(long long),sendBuffer,newsockfd,buffer_size);
}
...
void invoker_connect_client_dispatcher_lb(void** ref,void** dispatcherRef, void** portRef, char* host,int port,int buffer_size){
  if(*dispatcherRef==NULL){
     *dispatcherRef=new cca::cfd::LBSolverNativeDispatcher();
     ((cca::cfd::CouplingDriverImplementation*)(*ref))->connectlb((cca::cfd::LBSolverNativeDispatcher*) *dispatcherRef);   
  }
...
,MPI_Comm communicator, int methodId
 ...
 ((cca::cfd::CouplingDriverImplementation*)*ref)->disconnectlb();
}
...
readData((char*)configFile,configFile_str_len,rcvBuffer,newsockfd,buffer_size);
  ...
  ((cca::cfd::CouplingDriverImplementation*)*ref)->go(configFile);
...
std::string retrieveSocketAddress(){
	...
	assert(_sockfd>=0);
	const char* network_interface = getenv("CCA_CFD_COUPLINGDRIVER_NET_INTERFACE");
...
void* parallel_deamon_run(void* daemon_args){
	parallel_worker_loop(((CCA_CFD_COUPLINGDRIVER_arg*)daemon_args)->ref,((CCA_CFD_COUPLINGDRIVER_arg*)daemon_args)->communicator);
}
#endif
...
void* server_deamon_run(void* daemon_args){
      ...
      int clientfd=0;
#endif
      accept_on_server(((CCA_CFD_COUPLINGDRIVER_arg*)daemon_args)->daemon_serverfd,clientfd);
      std::cout<<"server accepted"<<std::endl;
      socket_worker_loop(
      	((CCA_CFD_COUPLINGDRIVER_arg*)daemon_args)->ref,
      	clientfd,
      	((CCA_CFD_COUPLINGDRIVER_arg*)daemon_args)->buffer_size
#ifdef Parallel
		,((CCA_CFD_COUPLINGDRIVER_arg*)daemon_args)->communicator
#endif      	
      	);
}
void startMPIDaemon(CCA_CFD_COUPLINGDRIVER_arg& arg){
#ifdef Parallel	 
int rank = -1;
MPI_Comm_rank(MPI_COMM_WORLD,&rank);
if(rank>0){
...
void startSocketDaemons(CCA_CFD_COUPLINGDRIVER_arg& arg){
...
void initialiseENV(CCA_CFD_COUPLINGDRIVER_arg& arg){
          const char* client_port = getenv("CCA_CFD_COUPLINGDRIVER_PORT");
          const char* daemon_port = getenv("CCA_CFD_COUPLINGDRIVER_DAEMON_PORT");
          const char* buffer_size = getenv("CCA_CFD_COUPLINGDRIVER_BUFFER_SIZE");
          const char* hostname = getenv("CCA_CFD_COUPLINGDRIVER_HOSTNAME");
          const char* java_client_flag = getenv("CCA_CFD_COUPLINGDRIVER_JAVA");
          const char* number_of_workers = getenv("CCA_CFD_COUPLINGDRIVER_WORKERS");
          const char* xmlFile = getenv("CCA_CFD_COUPLINGDRIVER_XML");
          if(buffer_size!=NULL)
...
void initialiseXMLDaemons(CCA_CFD_COUPLINGDRIVER_arg& arg){
    int rank=0;
...
invokers[20]=invoker_create_client_port_for_lb;
          ...
          {
            if(strcmp(e->Attribute("name"),"cca.cfd.CouplingDriver")==0){
                 int port;
...
void initialiseXMLConnections(CCA_CFD_COUPLINGDRIVER_arg& arg){
    int rank=0;
...
void initialiseParallel(CCA_CFD_COUPLINGDRIVER_arg& arg){
#ifdef Parallel
     int rank = -1 ;
     int comm_size;
     std::stringstream st;
...
#ifdef _WIN32
void INITIALISE(CCA_CFD_COUPLINGDRIVER_arg& arg,bool joinable){
#else
void initialise_(CCA_CFD_COUPLINGDRIVER_arg& arg,bool joinable){
#endif
...
#ifdef _WIN32
void BIND_COMPONENT(CCA_CFD_COUPLINGDRIVER_arg& arg,bool joinable){
#else
void bind_component_(CCA_CFD_COUPLINGDRIVER_arg& arg,bool joinable){
#endif
   if(arg.java_client_flag)         
     open_client(arg.hostname.c_str(),arg.client_port.c_str(),arg.java_serverfd,arg.java_clientfd);
...
#ifdef _WIN32
void DESTROY(CCA_CFD_COUPLINGDRIVER_arg& arg, bool joinable){
#else
void destroy_(CCA_CFD_COUPLINGDRIVER_arg& arg, bool joinable){
#endif
if(joinable){
#ifdef _WIN32
...
#ifdef _WIN32
void SOCKET_LOOP(CCA_CFD_COUPLINGDRIVER_arg& arg,bool joinable){
#else
void socket_loop_(CCA_CFD_COUPLINGDRIVER_arg& arg,bool joinable){
#endif
  if(arg.java_client_flag)       
