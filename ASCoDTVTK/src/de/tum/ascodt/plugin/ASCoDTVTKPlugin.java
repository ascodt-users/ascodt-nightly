...
public class ASCoDTVTKPlugin extends AbstractUIPlugin {
  ...
  public void loadNativeLibraries() {
    ...
    if (false && System.getProperty("os.name").contains("Linux")) {
      ...
      // "loadNativeLibraries()",
      // new
      // ASCoDTException(ASCoDTVTKPlugin.class.getCanonicalName(),"loadNativeLibraries()","VTK libraries not loaeded! Please report the bug to me!",null));
      // }catch(Exception e){
      // ErrorWriterDevice.getInstance().showError( getClass().getName() ,
      // "loadNativeLibraries()", e);
      // }
    } else {
      ...
      // now), i.e. not rely on the fact whether the appropriate version of VTK
      // is
      ...
      // dependency resolution by OS. As a result, this block aims to load all
      // VTK
