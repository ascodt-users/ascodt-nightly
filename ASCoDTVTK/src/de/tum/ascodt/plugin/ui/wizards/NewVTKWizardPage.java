...
public class NewVTKWizardPage extends WizardPage implements RepositoryListener {
	private String _initialProjectIdentifier;
	private Project _lastProject;
	public NewVTKWizardPage(String pageName) {
		super(pageName);
	...
	public void createControl(Composite parent) {
		...
		creatVTKCreationGroup(composite);
	 ...
	 */
	private final void creatVTKCreationGroup(Composite parent) {
