...
public class ASCoDTException extends java.lang.Exception {
   ...
   * 
   * @param className
   *          Class name of the first class that has catched the orginal
   *          exception. Usually, you can simply write down
   *          getClass().getName().
   * @param methodName
   *          Method name of the first class that has catched the orginal
   *          exception.
   * @param message
   *          Short description, in particular of the implication of the error,
   *          i.e. something like 'cannot create project'
   * @param cause
