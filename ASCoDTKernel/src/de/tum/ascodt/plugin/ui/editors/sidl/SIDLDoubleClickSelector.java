...
public class SIDLDoubleClickSelector implements ITextDoubleClickStrategy {
   ...
   */
  public SIDLDoubleClickSelector() {
    super();
  }
  ...
  /**
   * Match the brackets at the current selection. Return <code>true</code> if
  ...
  /**
   * Select the word at the current selection location. Return <code>true</code>
   * if successful, <code>false</code> otherwise.
   * 
   * @return <code>true</code> if a word can be found at the current selection
   ...
   * 
   * @return <code>true</code> if selection was successful, <code>false</code>
   *         otherwise
   */
