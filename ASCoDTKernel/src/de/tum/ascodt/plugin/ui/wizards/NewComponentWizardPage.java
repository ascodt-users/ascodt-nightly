...
/**
 * A wizard class which helps with the creation of new components. After
 * specifing the
 * name and the namespace of the component, the wizard creates the corresponding
 * sidl file
...
public class NewComponentWizardPage extends WizardPage {
  ...
  /**
   * Returns the current component name as entered by the user, or its
   * anticipated
   * initial value.
   * 
   * @return the component name, its anticipated initial value, or
   *         <code>null</code> if no component name is known
   */
   ...
   *          the _initialProjectIdentifier to set
   */
