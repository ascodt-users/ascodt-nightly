...
public class LabelDirectEditManager extends DirectEditManager {
  ...
  /**
   * Used to determine the initial text of the cell editor and to determine the
   * font size
   * of the text.
   * 
  ...
  protected IFigure getDirectEditFigure() {
    return ((StickyNoteEditPart)getEditPart()).getDirectEditFigure();
  }
  ...
  protected String getInitialText() {
    return ((StickyNoteEditPart)getEditPart()).getDirectEditText();
  }
