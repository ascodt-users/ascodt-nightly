 ...
 * Normal selection is denoted by highlight only. Borrowed from the Flow Editor
 * example
 * 
 * @author Daniel Lee
 */
public class EditableLabel extends Label {
  ...
  /**
   * paints figure differently depends on the whether the figure has focus or is
   * selected
   */
  @Override
