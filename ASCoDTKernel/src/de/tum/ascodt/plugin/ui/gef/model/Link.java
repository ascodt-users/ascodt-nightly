...
public class Link extends ModelElement {
   ...
   * 
   * @param source
   *          a source endpoint for this link (non null)
   * @param target
   *          a target endpoint for this link (non null)
  ...
  /**
   * Reconnect this link.
   * The link will reconnect with the component/sticky note it was previously
   * attached to.
   */
   ...
   * 
   * @param newSource
   *          a new source endpoint for this link (non null)
   * @param newTarget
   *          a new target endpoint for this link (non null)
   * @throws IllegalArgumentException
   ...
   * 
   * @param lineStyle
   *          one of following values: Graphics.LINE_DOT
   * @see Graphics#LINE_DOT
   * @throws IllegalArgumentException
   *           if lineStyle does not have the above value
   */
  ...
  /**
   * Source was deleted, disconnect this link from the target note it is
   * attached to.
   */
  ...
  /**
   * Target was deleted, disconnect this link from the source component it is
   * attached to.
   */
