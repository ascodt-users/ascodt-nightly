...
public class ComponentBorder extends org.eclipse.draw2d.LineBorder {
  ...
  private boolean isLink = false; // true if
                                  // connection
                                  // from component
                                  // is a link
                                  // to a sticky
  ...
  public ConnectionAnchor getSourceConnectionAnchorAt(Point p) {
    return getClosestConnectionAnchor(p, outputConnectionAnchors);
  }

  public ConnectionAnchor getTargetConnectionAnchorAt(Point p) {
    return getClosestConnectionAnchor(p, inputConnectionAnchors);
  }
