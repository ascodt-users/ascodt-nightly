...
public class CreateSocketProxyForCxx extends
  ...
  public void inAClassPackageElement(AClassPackageElement node) {
    ...
    try {
      ...
      String destinationFileForC2CxxProxyImplementation = _generatedFilesDirectory
          .toString() +
          File.separatorChar +
          _fullQualifiedName.replaceAll("[.]", "/") + "C2CxxProxy.cpp";
      String destinationFileForC2CxxProxyHeader = _generatedFilesDirectory
          .toString() +
          File.separatorChar +
  ...
  public void inAOperation(AOperation node) {
    ...
    try {
      ...
      TemplateFile c2CxxProxyImplementationTemplate = new TemplateFile(
          ...
          templateC2CxxProxyImplementationFile);
  ...
  public void inAUses(AUses node) {
    ...
    try {
      TemplateFile templateForC2Cxx = new TemplateFile(
          _templateFilesOfC2CxxProxyImplementation.peek(), templateFileForC2Cxx);
