...
public class CreateJavaComponentInterface extends DepthFirstAdapter {
  ...
  public void inAClassPackageElement(AClassPackageElement node) {
    ...
    try {
      ...
      case JavaLocal:
        extendingInterfaces += de.tum.ascodt.repository.entities.Component.class
            .getCanonicalName();
        break;
      case CxxRemoteSocket:
        extendingInterfaces += de.tum.ascodt.repository.entities.CxxRemoteSocketComponent.class
            .getCanonicalName();
        break;
      case JavaNative:
        extendingInterfaces += de.tum.ascodt.repository.entities.NativeComponent.class
            .getCanonicalName();
        break;
      case ReverseCxxRemoteSocket:
        extendingInterfaces += de.tum.ascodt.repository.entities.CxxReverseRemoteSocketComponent.class
            .getCanonicalName();
        break;
      default:
        extendingInterfaces += de.tum.ascodt.repository.entities.Component.class
