...
public class CreateSocketProxyForFortran extends DepthFirstAdapter {
  private Trace _trace =
      new Trace(CreateSocketProxyForFortran.class.getCanonicalName());
  ...
  public void inAClassPackageElement(AClassPackageElement node) {
    ...
    _templateFilesOfC2FProxyImplementation.push(new TemplateFile(Paths.get("native-component-c2f-socket-implementation.template"),
  ...
  public void inAOperation(AOperation node) {
    ...
    try {
      ...
      TemplateFile c2FProxyImplementationTemplate =
          new TemplateFile(_templateFilesOfC2FProxyImplementation.peek(),
                           Paths.get("native-component-c2f-socket-implementation-provides-port.template"));
      ...
      c2FProxyImplementationTemplate.addMapping("__OPERATION_PARAMETERS_LIST__",
                                                parameterList.getParameterListInJNI(onlyInParameters.areAllParametersInParameters()));
      c2FProxyImplementationTemplate.addMapping("__OPERATION_NAME__",
                                                node.getName().getText());
      c2FProxyImplementationTemplate.addMapping("__OPERATION_NAME_4WIN__",
                                                node.getName()
                                                    .getText()
                                                    .toUpperCase());
      c2FProxyImplementationTemplate.addMapping("__F_OPERATION_NAME__",
                                                node.getName()
                                                    .getText()
                                                    .toLowerCase());
      ...
      c2FProxyImplementationTemplate.addMapping("__F_OPERATION_NAME_4WIN__",
                                                node.getName()
                                                    .getText()
                                                    .toUpperCase());
      c2FProxyImplementationTemplate.addMapping("__OPERATION_PARAMETERS_LIST_C2F__",
      ...
      c2FProxyImplementationTemplate.addMapping("__FUNCTION_CALL_PARAMETERS_LIST__",
                                                funcCallParamters);
  ...
  public void inAUses(AUses node) {
    ...
    try {
      TemplateFile templateForC2F =
          new TemplateFile(_templateFilesOfC2FProxyImplementation.peek(),
                           Paths.get("native-component-c2f-socket-implementation-uses-ports.template"));
      ...
      TemplateFile templateForFProxy =
          new TemplateFile(_templateFilesOfFortranProxyImplementation.peek(),
                           Paths.get("native-component-fproxy-implementation-uses-port.template"));
