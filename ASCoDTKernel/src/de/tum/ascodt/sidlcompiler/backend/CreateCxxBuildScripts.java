 ...
 * 
 */
public class CreateCxxBuildScripts extends
  ...
  private void createComponentMappings(String componentName,
      String fullQualifiedName, java.util.Stack<TemplateFile> template) {
  ...
  public void inAClassPackageElement(AClassPackageElement node) {
    try {
      ...
      String fullQualifiedName = _symbolTable.getScope(node)
          .getFullQualifiedName(componentName);

      String templateFileForCxxMakefile = "makefile-cxx.template";
      String destinationFileForCxxMakefile = _userImplementationsDestinationDirectory
      ...
      String destinationFileForCxxCMakefile = _userImplementationsDestinationDirectory
          .toString() +
          File.separatorChar +
          "cmake-" +
          fullQualifiedName +
          File.separatorChar + "CMakeLists.txt";
      String destinationFileForSourcesCxxCMakefile = _userImplementationsDestinationDirectory
          .toString() +
          File.separatorChar +
          "cmake-" +
          fullQualifiedName +
          File.separatorChar + "sources.cmake";
      String destinationFileForTargetsCxxCMakefile = _userImplementationsDestinationDirectory
          .toString() +
          File.separatorChar +
          "cmake-" +
          fullQualifiedName +
