 ...
 *
 */
public class CreateJavaFortranNativeComponent extends de.tum.ascodt.sidlcompiler.frontend.analysis.DepthFirstAdapter{
	private Trace                      _trace = new Trace(CreateJavaFortranNativeComponent.class.getCanonicalName());
	...
	CreateJavaFortranNativeComponent(SymbolTable symbolTable, URL userImplementationsDestinationDirectory
