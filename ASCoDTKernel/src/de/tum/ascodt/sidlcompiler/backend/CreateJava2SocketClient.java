 ...
 *
 */
public class CreateJava2SocketClient extends de.tum.ascodt.sidlcompiler.frontend.analysis.DepthFirstAdapter{
	private Trace                      _trace = new Trace(CreateJava2SocketClient.class.getCanonicalName());
	...
	public void inAClassPackageElement(AClassPackageElement node) {
		...
		_templateFilesForAbstractComponent.peek().addMapping("__SOCKET_CLIENT_UI__",SocketClientAppsTab.class.getCanonicalName());
