...
public class CreateComponentsAndInterfaces {
  ...
  public void create(URL generatedFilesDestinationDirectory,
    ...
    for (de.tum.ascodt.sidlcompiler.frontend.node.AEnumDeclarationPackageElement enumeration : _symbolTable
    ...
    try {
      for (de.tum.ascodt.sidlcompiler.frontend.node.AClassPackageElement component : _symbolTable
          .getGlobalScope().getFlattenedClassElements()) {
  ...
  public void generatePorts(URL generatedFilesDestinationDirectory,
    ...
    for (de.tum.ascodt.sidlcompiler.frontend.node.AInterfacePackageElement port : _symbolTable
        .getGlobalScope().getFlattenedInterfaceElements()) {
